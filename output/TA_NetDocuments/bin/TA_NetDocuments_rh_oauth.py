...
logger = log.Logs().get_logger('ta_netdocuments_rh_oauth2_token')
...
class ta_netdocuments_rh_oauth2_token(admin.MConfigHandler):
    ...
    def getProxyDetails(self):
        ...
        ), "TA_NetDocuments", realm="__REST_CREDENTIAL__#TA_NetDocuments#configs/conf-ta_netdocuments_settings")
        # Get Conf object of apps settings
        conf = cfm.get_conf('ta_netdocuments_settings')
...
if __name__ == "__main__":
    admin.init(ta_netdocuments_rh_oauth2_token, admin.CONTEXT_APP_AND_USER)